...
public final class FragmentMapBinding implements ViewBinding {
  ...
  @NonNull
  public final FloatingActionButton btnBackMap;

  private FragmentMapBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton btnBackMap) {
    this.rootView = rootView;
    this.btnBackMap = btnBackMap;
  }
  ...
  public static FragmentMapBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.btn_back_map;
      FloatingActionButton btnBackMap = ViewBindings.findChildViewById(rootView, id);
      if (btnBackMap == null) {
        break missingId;
      }

      return new FragmentMapBinding((ConstraintLayout) rootView, btnBackMap);
    }
